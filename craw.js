...
const nightmare_pexel = Nightmare({ show: true, waitTimeout: 6000});
const vo = require('vo');
...
const server = app.listen(5566, function() {
...
function pexels_background_search(type){
  ...
  var run = function * () {
    ...
    yield nightmare_pexel.proc.disconnect();
    yield nightmare_pexel.kill();
    yield nightmare_pexel.ended = true;
    yield nightmare_pexel = null;
    return urls;
  };    
